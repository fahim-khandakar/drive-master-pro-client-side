  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2  gap-5 my-10">
      <div className="text-left mt-10">
        ...
        <p>
          Browse through our extensive collection of top-quality vehicles. Find
          the perfect car that suits your style, needs, and budget from our
          diverse listings.
        </p>
      </div>
      {/* second  */}
      <div className="text-left mt-10">
        ...
        <p>
          Streamline your car-buying experience with our trade-in and financing
          options. We offer flexible solutions to help you drive your dream car.
        </p>
      </div>
      {/* third  */}
